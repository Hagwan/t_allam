...
class VegDeatilsScreen extends StatefulWidget {
  final String groupName;
  final List<String> letters;

  const VegDeatilsScreen({
    Key? key,
  ...
  @override
  _VegDeatilsScreenState createState() => _VegDeatilsScreenState();
}

class _VegDeatilsScreenState extends State<VegDeatilsScreen> {
  final ArabicAlphabetModel _speechModel = ArabicAlphabetModel();
  final AudioPlayer _audioPlayer = AudioPlayer();
  final VegGenerator _VegGenerator = VegGenerator();
  ...
  Future<void> _generateFruitAndSpeak(String letter) async {
    ...
    try {
      ...
      String fruit = await _VegGenerator.getFruitName(letter);
      setState(() {
        _generatedFruit = fruit;
      });

      // Translate the fruit name to English
      String translatedFruit = await _VegGenerator.translateToEnglish(fruit);
